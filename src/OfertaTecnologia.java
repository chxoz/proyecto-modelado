/**
 * Clase Oferta alimentos para genrar ofertas  aleatorias sobre la laptop
 * extiende Oferta
 * @authors Daniela Anaya Solis, Mauricio López Miranda 
 * @version 1.0 /Nov/2021
 */
public class OfertaTecnologia extends Oferta{
    ...
    public String aplicaOferta(int random){
        Producto rebajado = catalogo.getProducto(2);
        int precio = 13999;
